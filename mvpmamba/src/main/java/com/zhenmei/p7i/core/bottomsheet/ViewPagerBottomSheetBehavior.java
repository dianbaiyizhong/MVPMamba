...
public class ViewPagerBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    View findScrollingChild(View view) {
        ...
        if (view instanceof ViewPager) {
            ...
            for (int i = 0, count = group.getChildCount(); i < count; i++) {
                ...
                //加上这个判断 scrollingChild.getVisibility() == View.VISIBLE  解决多个recycleview问题
                if (scrollingChild != null && scrollingChild.getVisibility() == View.VISIBLE) {
                    return scrollingChild;
                }
            }
        }
     ...
     * @attr ref com.google.android.material.R.styleable#ViewPagerBottomSheetBehavior_Layout_behavior_peekHeight
     */
     ...
     * @attr com.google.android.material.R.styleable#ViewPagerBottomSheetBehavior_Layout_behavior_halfExpandedRatio
     */
     ...
     * @attr com.google.android.material.R.styleable#ViewPagerBottomSheetBehavior_Layout_behavior_expandedOffset
     */
     ...
     * @attr ref com.google.android.material.R.styleable#ViewPagerBottomSheetBehavior_Layout_behavior_hideable
     */
     ...
     * @attr ref com.google.android.material.R.styleable#ViewPagerBottomSheetBehavior_Layout_behavior_skipCollapsed
     */
     ...
     *              {@link #SAVE_NONE}.
     * @attr ref com.google.android.material.R.styleable#ViewPagerBottomSheetBehavior_Layout_behavior_saveFlags
     * @see #getSaveFlags()
     */
